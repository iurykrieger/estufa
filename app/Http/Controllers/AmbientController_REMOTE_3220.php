...
class AmbientController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('ambients.index',['ambients' => $ambients, 'user' => Auth::user()]);
    }
    ...
    {
        return view('ambients.create',[ 'user' => Auth::user()]);
    }
    ...
    public function show($id)
    {
        ...
        return view('ambients.show',['ambient' => $ambient, 'user' => Auth::user()]);
    }
    ...
    {
        $ambient = Ambient::findOrFail($id);
        return view('ambients.edit', ['ambient' => $ambient, 'user' => Auth::user()]);
    }
